...
TEST_CASE("Ethernet tests", "[net][ethernet][packet]") {
    ...
    SECTION("Data should be the ones provided") {
        ...
        CHECK(frame.dstAddr() == "44:BA:7D:B0:B1:50");
        CHECK(frame.srcAddr() == "40:08:B1:60:B2:FF");
